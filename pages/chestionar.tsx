  ...
  return (
    <main className="relative h-screen">
      ...
      <Background>
        ...
        <div>
        <script defer src="https://static.airtable.com/js/embed/embed_snippet_v1.js"></script>
        <iframe 
        className="airtable-embed airtable-dynamic-height" 
        src="https://airtable.com/embed/appRLtK8JhlmcMcEa/shrdlAe64R2r2Qiar?backgroundColor=blue" 
        frameBorder="0" 
        // onmousewheel="" 
        width="100%" 
        height="1663" style={{background: "transparent", border: "1px solid #ccc"}}></iframe>
        </div>
      </Background>
